...
private:
	void breathfirst(nodeType<elemType> *p) const;
...
template <class elemType>
void binaryTreeType<elemType>::breathfirst() const
{
    breathfirst(root);
}
template <class elemType>
...
template <class elemType>
void binaryTreeType<elemType>::breathfirst(nodeType<elemType> *p) const
	{
	...
	queue<nodeType<elemType>*> q;
		...
		while (!q.empty()) {
			 nodeType<elemType> * temp_node = q.front();
		    q.pop();

		    if (temp_node->lLink) {
		      q.push(temp_node->lLink);
		      cout << temp_node->lLink->info << " ";
		    }

		    if (temp_node->rLink) {
		      q.push(temp_node->rLink);
		      cout << temp_node->rLink->info << " ";
		    }
		}
